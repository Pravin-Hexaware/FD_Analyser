...
from api.batch_xbrl_finder_crawl4ai import router as batch_inter_router
from api.xbrl_ws_route import router as xbrl_ws_router
from api.xbrl_ws_crawl4ai import router as xbrl_ws_crawl4ai_router
...
app.include_router(xbrl_ws_crawl4ai_router, prefix="/api", tags=["xbrl_ws_crawl4ai"])
