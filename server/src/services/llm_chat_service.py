...
async def get_chat_history() -> list[ChatHistoryResponse]:
...
async def get_conversation(chat_id: str) -> ConversationResponse:
    try:
...
async def delete_unknown_sector_companies() -> dict:
    repo = SqliteRepository()
    try:
